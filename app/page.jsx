          ...
          {messages.length === 0 ? (
            <>
              <div className="flex items-center gap-3">
                ...
                <p className=" text-2xl font-medium">Hello! I'm DeepSeek.</p>
              </div>
              <p className=" text-sm mt-2">How Can I Help You Today?</p>
            </>
          ) :
            (
              <div ref={containerRef} className=" relativeflex flex-col items-center justify-start w-full mt-20 max-h-screen overflow-y-auto">
